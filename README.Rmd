...
---
# Word Embeddings
This repository contains the replication materials for the article "Word Embeddings: What works, what doesn't and how to tell the difference for applied research", to be published in _The Journal of Politics_, by Pedro L. Rodriguez and Arthur Spirling.
