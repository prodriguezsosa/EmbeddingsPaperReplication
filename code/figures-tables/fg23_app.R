...
## load data
corr_politics <- readRDS('./data/cr/word2vec/correlations/across_corr_pearson_politics.rds')
corr_random <- readRDS('./data/cr/word2vec/correlations/across_corr_pearson_random.rds')
...
ggsave(paste0('./figures/fg23a_app.png'))
...
ggplot(data = melted_adj, aes(Var2, Var1, fill = value)) +
  ...
  theme(
    ...
    axis.text.y = element_text(size=18),
    panel.grid.major = element_blank())
ggsave(paste0('./figures/fg23b_app.png'))
